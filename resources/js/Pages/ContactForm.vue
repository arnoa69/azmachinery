                ...
                <div class="row gy-4">
                  <div class="col-md-6">
                    ...
                    >
                      ...
                      <option value="specific_needs">
                        {{ $t("contact.form.select.specific-need") }}
                      </option>
                      <option value="custom_manufacturing">
                        {{ $t("contact.form.select.custom-manufacturing") }}
                      </option>
                      <option value="transport_quote">
                        {{ $t("contact.form.select.transport-quote") }}
                      </option>
                      <option value="financing">
                        {{ $t("contact.form.select.need-financing") }}
                      </option>
                    </select>
                  </div>
                  ...
                  <div class="col-md-6">
                    <input
                      ...
                      v-model="name"
                      class="form-control"
                      :placeholder="$t('contact.form.get-a-quote.placeholder.name')"
                      required=""
                    />
                  </div>
                  ...
                  <div class="col-md-12">
                    <input
                      ...
                      class="form-control"
                      name="email"
                      :placeholder="$t('contact.form.get-a-quote.placeholder.email')"
                      required=""
                    />
                  </div>
                  ...
                  <div class="col-md-12">
                    <input
                      ...
                      class="form-control"
                      name="phone"
                      :placeholder="$t('contact.form.get-a-quote.placeholder.phone')"
                      required=""
                    />
                  </div>
                  ...
                  <div class="col-md-12 text-center">
                    ...
                    <button type="submit">
                      {{ $t("contact.form.placeholder.send") }}
                    </button>
                  </div>
                </div>
              </form>
